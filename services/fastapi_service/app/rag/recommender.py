...
DEFAULT_TOP_K = int(os.getenv("RECOMMENDER_TOP_K", "6"))
DEFAULT_MIN_TOP_K = int(os.getenv("RECOMMENDER_MIN_TOP_K", "2"))
DEFAULT_VECTOR_CANDIDATES = int(os.getenv("RECOMMENDER_VECTOR_CANDIDATES", "48"))
DEFAULT_SPARSE_CANDIDATES = int(os.getenv("RECOMMENDER_SPARSE_CANDIDATES", "32"))
DEFAULT_MAX_SPARSE_SCAN = int(os.getenv("RECOMMENDER_MAX_SPARSE_SCAN", "5000"))
DEFAULT_MAX_PER_SOURCE = int(os.getenv("RECOMMENDER_MAX_PER_SOURCE", "3"))
DEFAULT_MAX_CONTEXT_CHARS = int(os.getenv("RECOMMENDER_MAX_CONTEXT_CHARS", "3200"))
DEFAULT_MAX_CHUNK_CHARS = int(os.getenv("RECOMMENDER_MAX_CHUNK_CHARS", "760"))
...
def _get_collection(chroma_dir: str = CHROMA_DIR, collection_name: str = COLLECTION_NAME):
    return get_collection(chroma_dir=chroma_dir, collection_name=collection_name)
